...
public class OverworldObjects {
    ...
    public static void register() {
        ...
        /*
            Vial & Knife Boxes
         */
        new GameObject(29317, new Position(2546, 3885, 0), 10, 0).spawn();
        new GameObject(29320, new Position(2542, 3885, 0), 10, 0).spawn();

        ObjectAction.register(29317, 2546, 3885, 0, "Take-knife", (p, o) -> {
            p.getInventory().add(ItemID.KNIFE);
        });
        ObjectAction.register(29319, 2544, 3885, 0, "Take-tinderbox", (p, o) -> {
            p.getInventory().add(ItemID.TINDERBOX);
        });
        ObjectAction.register(29320, 2542, 3885, 0, "Take-concoction", (p, o) -> {
            p.getInventory().add(ItemID.EMPTY_VIAL);
        });
        ObjectAction.register(29320, 2542, 3885, 0, "Take-5-concoction", (p, o) -> {
            p.getInventory().add(ItemID.EMPTY_VIAL, 5);
        });
