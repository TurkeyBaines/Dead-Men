...
public class Ranalph extends NPCCombat {
    ...
    private static final int MELEE_PRAYER = 8300;
    private static final int RANGED_PRAYER = 8301;
    private static final int MAGIC_PRAYER = 8302;
