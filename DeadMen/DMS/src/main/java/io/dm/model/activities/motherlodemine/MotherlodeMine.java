package io.dm.model.activities.motherlodemine;
...
import static io.dm.model.skills.Tool.HAMMER;
...
public class MotherlodeMine { //why do we have two motherlode mine classes? Remove the one from skilling and add the actions here
    ...
    static {
        MapListener.registerRegion(14936)
                .onEnter(io.dm.model.activities.motherlodemine.MotherlodeMine::entered)
                .onExit(io.dm.model.activities.motherlodemine.MotherlodeMine::exited);
    }
