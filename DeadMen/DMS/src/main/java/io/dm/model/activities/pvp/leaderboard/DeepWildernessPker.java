package io.dm.model.activities.pvp.leaderboard;
...
public class DeepWildernessPker implements Pker {
    private Player player;
    private int kills;
    private int deaths;

    public DeepWildernessPker(Player player) {
        this.player = player;
    }
    ...
    public int compareTo(DeepWildernessPker v2) {
