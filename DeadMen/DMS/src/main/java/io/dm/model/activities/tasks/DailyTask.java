...
import io.dm.model.entity.shared.listeners.DailyResetListener;
...
import static io.dm.cache.ItemID.BLOOD_MONEY;
import static io.dm.model.activities.tasks.DailyTaskDifficulty.*;
import static io.dm.model.activities.tasks.NPCKillTaskListener.*;
import static io.dm.model.activities.tasks.PlayerKillTaskListener.*;
