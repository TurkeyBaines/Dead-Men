...
import io.dm.model.entity.shared.listeners.*;
import io.dm.model.entity.shared.masks.*;
...
import io.dm.model.item.containers.Trade;
...
import io.dm.model.skills.farming.Farming;
import io.dm.model.skills.hunter.Hunter;
import io.dm.model.stat.StatList;
import io.dm.model.stat.StatType;
import io.dm.network.PacketSender;
import io.dm.api.buffer.OutBuffer;
import io.dm.api.filestore.utility.Huffman;
import io.dm.api.protocol.Protocol;
import io.dm.social.SocialList;
import io.dm.social.SocialMember;
import io.dm.social.clan.ClanChat;
import io.dm.utility.PlayerLookup;
import io.dm.network.incoming.IncomingDecoder;
import io.dm.services.Hiscores;
...
import static io.dm.cache.ItemID.*;
...
public class Player extends PlayerAttributes {
    ...
    public void sendReceivePM(String fromName, int fromRank, String message) {
        OutBuffer out = new OutBuffer(255).sendVarShortPacket(45)
                .addString(fromName);
        for (int i = 0; i < 5; ++i) {
            out.addByte(io.dm.api.utils.Random.get(255));
        }
