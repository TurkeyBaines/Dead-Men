...
import io.dm.model.combat.special.magic.StaffOfTheDead;
import io.dm.model.combat.special.melee.VestasSpear;
import io.dm.model.combat.special.ranged.DragonThrownaxe;
import io.dm.model.combat.special.ranged.ToxicBlowpipe;
...
import io.dm.model.item.actions.impl.chargable.*;
import io.dm.model.item.actions.impl.combine.SlayerHelm;
import io.dm.model.item.actions.impl.jewellery.PhoenixNecklace;
import io.dm.model.item.actions.impl.jewellery.RingOfLife;
import io.dm.model.item.actions.impl.jewellery.RingOfRecoil;
import io.dm.model.item.actions.impl.jewellery.RingOfSuffering;
import io.dm.model.item.actions.impl.skillcapes.DefenceSkillCape;
...
import io.dm.model.skills.magic.spells.lunar.Vengeance;
import io.dm.model.skills.prayer.Prayer;
import io.dm.model.skills.prayer.Redemption;
import io.dm.model.skills.prayer.Retribution;
...
import static io.dm.model.inter.Interface.COMBAT_OPTIONS;
