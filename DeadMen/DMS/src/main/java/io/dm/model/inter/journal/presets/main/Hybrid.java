package io.dm.model.inter.journal.presets.main;
...
public class Hybrid extends Preset {
    ...
    public Hybrid() {
        ...
        invItems[0] = new Item(RUNE_PLATEBODY, 1);
        invItems[1] = new Item(RUNE_DEFENDER, 1);
        invItems[2] = new Item(BLACK_DRAGONHIDE_BODY, 1);
        invItems[3] = new Item(SUPER_STRENGTH_POTION_4, 1);
        invItems[4] = new Item(RUNE_PLATELEGS, 1);
        invItems[5] = new Item(DRAGON_SCIMITAR, 1);
        invItems[6] = new Item(DRAGON_DAGGERP, 1);
        invItems[7] = new Item(SUPER_ATTACK_POTION_4, 1);
        invItems[8] = new Item(SHARK, 1);
        invItems[9] = new Item(SHARK, 1);
        invItems[10] = new Item(SARADOMIN_BREW_4, 1);
        ...
        invItems[27] = new Item(TELEPORT_HOME, 10);
