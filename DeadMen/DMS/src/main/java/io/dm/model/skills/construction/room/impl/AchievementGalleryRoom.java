...
import io.dm.model.item.actions.impl.MaxCape;
...
import static io.dm.model.item.actions.impl.MaxCape.MaxCapes.*;
import static io.dm.model.skills.construction.Buildable.CAPE_HANGER;
