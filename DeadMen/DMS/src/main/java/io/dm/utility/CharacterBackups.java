...
public class CharacterBackups {
    ...
    private static final String BACKUP_PATH = io.dm.api.utils.ServerPaths.getBackups() + "/";
    ...
    public void start() {
        if (World.stage == WorldStage.LIVE) {
            ...
            CHARACTER_SAVES_PATH = io.dm.api.utils.ServerPaths.getPlayers(World.stage.name().toLowerCase(), World.type.name().toLowerCase()) + "/";
        }
    }
