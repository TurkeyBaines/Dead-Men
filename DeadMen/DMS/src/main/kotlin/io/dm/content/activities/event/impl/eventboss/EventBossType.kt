...
import io.dm.content.activities.event.impl.eventboss.tabel.BrutalLavaDragonLoot
import io.dm.content.activities.event.impl.eventboss.tabel.CorruptedNechryarchLoot
...
enum class EventBossType(val id: Int, val positions: MutableList<Position>, val hitpoints: Int, val message: MutableList<String>, val rolls: Int, val lootTable: LootTable, val embedUrl: String, val pet: Pet, val petChance: Int) {
    ...
    "https://i.imgur.com/hnjb4vw.png", Pet.DAGANNOTH_REX, 150),
    ...
    "https://i.imgur.com/uZWY3ap.png", Pet.DAGANNOTH_REX, 150)
}
