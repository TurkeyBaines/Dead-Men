package io.dm.content.activities.tournament.presets

import io.dm.api.utils.Tuple
import io.dm.content.activities.tournament.TournamentAttributes
...
object DhRangedTournamentAttributes : TournamentAttributes {
    override fun playlist(): TournamentPlaylist {
        return TournamentPlaylist.DH_RANGED
    }
    ...
    override fun equipmentLoadout(): Array<Tuple<Int, Item>> {
        return arrayOf(
                ...
                Tuple(Equipment.SLOT_AMULET, Item(1712)),
                Tuple(Equipment.SLOT_WEAPON, Item(12788)),
                Tuple(Equipment.SLOT_CHEST, Item(2503)),
                ...
                Tuple(Equipment.SLOT_AMMO, Item(21326, 400))
        )
    }
